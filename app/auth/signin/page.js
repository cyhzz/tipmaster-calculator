            ...
            <div className="max-w-md w-full">
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">TipMaster</h1>
                    </div>

                    <h2 className="text-xl font-bold text-gray-800 mb-2">Sign In</h2>
                    <p className="text-gray-600 mb-6">
                        Sign in to access your calculation history and premium features.
                    </p>
        ...
        <Suspense fallback={
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">Preparing sign-in options...</p>
                </div>
            </div>
        }>
            <SignInContent />
